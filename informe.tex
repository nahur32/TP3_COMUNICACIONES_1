...
\chead{\vspace{-.05cm}\textcolor{gray}{Sistemas de Comunicaciones, teoría de la información y Análisis de Señales - TP N.$^o$2} \vspace{.25cm}}
...
\begin{document}
    ...
    \input{Parte_1/Actividad_1} %llama los otros 
	%\input{Actividades/Actividad_2}
	%\input{Actividades/Actividad_3}
	%\input{Actividades/Actividad_4}
	%\input{Actividades/Actividad_5}
	%\input{Actividades/Actividad_6}
	%\input{Actividades/Actividad_7}
	%\input{Actividades/Actividad_8}
